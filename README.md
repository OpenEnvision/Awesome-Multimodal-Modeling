...
| Ming-Flash-Omni: A Sparse, Unified Architecture for Multimodal Perception and Generation | arXiv 2025 | [Paper](https://arxiv.org/abs/2510.24821) [Code](https://github.com/inclusionAI/Ming) | Sparse unified architecture for multimodal perception and generation | multimodal perception & generation |
| RoboOmni: Proactive Robot Manipulation in Omni-modal Context | arXiv 2025 | [Paper](https://arxiv.org/abs/2510.23763) [Code](https://github.com/OpenMOSS/RoboOmni) | Proactive robot manipulation using omni-modal context with action generation | robotic manipulation |
...
| AnyGPT: Unified Multimodal LLM with Discrete Sequence Modeling | ACL 2024 | [Paper](https://aclanthology.org/2024.acl-long.521.pdf) [Code](https://github.com/OpenMOSS/AnyGPT) | Unified multimodal LLM using discrete sequence modeling | unified discrete multimodal |
| NExT-GPT: Any-to-Any Multimodal LLM | ICML 2023 | [Paper](https://arxiv.org/abs/2309.05519) [Code](https://github.com/NExT-GPT/NExT-GPT) | Any-to-any multimodal LLM | any-to-any |
| Unified-IO 2: Scaling Autoregressive Multimodal Models with Vision, Language, Audio, and Actions | CVPR 2023 | [Paper](https://arxiv.org/abs/2312.17172) [Code](https://github.com/allenai/unified-io-2) | Large-scale autoregressive multimodal model including actions | unified multimodal with actions |
...
| RoboEgo System Card: An Omnimodal Model with Native Full Duplexity | arXiv 2025 | [Paper](https://arxiv.org/abs/2506.01934) [Code](https://github.com/JAMESYJL/ShapeLLM-Omni) | Omnimodal model with native full duplexity | full duplex omnimodal |
