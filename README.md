...
|-------|-------|-------|-------|------|
| GPT-5.6 Sol (Preview) | OpenAI Blog | [Announcement](https://openai.com/index/introducing-gpt-5-6/) | June 2026 preview update in the GPT-5 series; proprietary frontier multimodal/reasoning model. | Omni-Modal + Advanced Reasoning |
