...
| UniMedVL: Unifying Medical Multimodal Understanding and Generation through Observation-Knowledge-Analysis | ICML 2026 | [Paper](https://arxiv.org/abs/2510.15710) [Code](https://github.com/uni-medical/UniMedVL) [HF](https://huggingface.co/General-Medical-AI/UniMedVL) | A unified model for multimodal understanding and generation in the medical domain | medical image understanding, virtual staining, super-resolution, cross-modal medical image synthesis |
